...
The goal of this project is to build a modular physics simulation tool for experimenting with dynamics, contraints, and controllers. I am implementing the core simulation components from scratch to better understand constraint solving and articulated dynamics. Ideally, it becomes a platform where I can test modern control techniques on rigid-bodies while learning the ins and outs of physical modeling, constraint handling, and dynamics.
